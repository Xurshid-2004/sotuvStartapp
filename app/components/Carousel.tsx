        ...
        {slides.map((s, i) => (
          ...
          >
            <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-10 max-w-[60%]">
              <p className="text-[var(--brand-primary-strong)] font-bold text-[11px] sm:text-sm uppercase tracking-wider mb-1">Tavsiya etamiz</p>
              ...
              {s.price && (
                <div className="mt-3 inline-flex items-center gap-1.5 bg-[var(--brand-primary)] text-[var(--brand-on)] font-black text-lg sm:text-2xl px-3 py-1 rounded-xl w-fit">
